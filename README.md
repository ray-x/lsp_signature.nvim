...
```lua
 ...
 cfg = {
  ...
  -- will set to true when fully tested, set to false will use which eveer side has more space
  -- this setting will be help if you do not want the PUM and floating win overlap
